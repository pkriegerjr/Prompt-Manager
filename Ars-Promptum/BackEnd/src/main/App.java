...
public class App {
    ...
    static final String SMTP_USER = " ";  // ← seu Gmail
    static final String SMTP_PASS = " ";  // ← App Password
    static final String BASE_URL    = "http://localhost:8080/Ars-Promptum/FrontEnd/pages";
